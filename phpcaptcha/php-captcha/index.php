...
<html>
<head>
<title> Novel Antiphising  Framework based on Visual Cryptography</title>
<link href="./assets/css/style.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <h2>Novel Antiphising Framework based on Visual Cryptography</h2>
    <form name="frmContact" method="post" action="">
        <table border="0" cellpadding="10" cellspacing="1" width="150%"
            class="demo-table">
            <tr class="tablerow">
